...
internal class ProductDetailsViewModelTest {
    ...
    private fun getViewModel() = ProductDetailsViewModel(getProductUseCase, sizeStream, colorStream)
    ...
    fun `GIVEN viewModel WHEN get product called throwable THEN received event ReceivedThrowable`() {
        ...
        // THEN
        assertTrue(viewModel.event.value == ProductDetailsViewModel.Event.ReceivedThrowable(throwable))
    }
}
